angular.module('cipaApp').controller('validacaoAprovadosCtrl', ['$scope', '$state', 'eleicoesAPI', 'sharedDataService', 'candidatosAPI', '$stateParams', function($scope, $state, eleicoesAPI, sharedDataService, candidatosAPI, $stateParams) {
	...
	var loadCandidatosEleicao = function() {
		candidatosAPI.getCandidatoValidacao(self.codEleicao, true)
		.then(function(dado) {
			self.error = null;
	...
	var stateRedirect = 'navContainer.aprovado';
