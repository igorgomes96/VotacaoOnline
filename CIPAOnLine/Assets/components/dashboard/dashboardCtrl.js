...
angular.module('cipaApp').controller('dashboardCtrl', ['isAllowed', '$scope', '$state', 'sharedDataService', 'eleicoesAPI', 'votosAPI', 'dateFilter', 'unidadesAPI', '$stateParams', 'isAllowed', function(isAllowed, $scope, $state, sharedDataService, eleicoesAPI, votosAPI, dateFilter, unidadesAPI, $stateParams, isAllowed) {
	...
	var loadGraficos = function(codigo) {
		//exibeLoader();
        // var spinnerCards = exibeSpinner('.card-dash');
        // var spinnerGraficoApuracaoGeral = exibeSpinner('#graficoApuracaoGeral');
        // var spinnerGraficoPercVotantes = exibeSpinner('#graficoPercVotantes');
        // var spinnerGraficoRelatorioVotos = exibeSpinner('#relatorioVotos');
		...
		.then(function(retorno) {
			...
			// var optionsVotantes = angular.copy(optionsGraphPie);

			// optionsVotantes.title.text = '(%) Votantes X Não Votantes'
			// optionsVotantes.series = [{
			// 	name:'Percentual (%)',
			// 	colorByPoint: true,
			// 	data: [{
			// 		name: 'Votantes',
			// 		y: retorno.data.Votantes
			// 	},{
			// 		name: 'Não Votantes',
			// 		y: retorno.data.NaoVotantes
			// 	}]
			// }];

			// carregaGrafico('graficoPercVotantes', optionsVotantes);

            //Remove os spinners e exibe os componentes
            //spinnerCards();
            ...
            //Remove todos os spinners
            // spinnerGraficoApuracaoGeral();
            // spinnerGraficoPercVotantes();
    ...
    var loadRelatorioEleitores = function() {
        //var spinner = exibeSpinner('#relatorio-eleitores');
        votosAPI.getRelatorioEleitores(self.codEleicao)
        .then(function(dado) {
